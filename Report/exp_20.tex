% Experiment 20: Disk Scheduling Simulator

\section{Experiment 20: Disk Scheduling Simulator}

\subsection{Problem Statement}
The objective is to implement \texttt{disksched} to simulate head movement.

The tool must:
\begin{itemize}
    \item Accept \verb|--max|, \verb|--start|, and \verb|--dir|.
    \item Read request cylinder list from stdin.
    \item Simulate FCFS, SSTF, SCAN, and C-SCAN.
    \item Report service order and total head movements.
\end{itemize}

\subsection{Source Code}
\begin{lstlisting}[language=C, caption={disksched.c}]
...
\textbf{Case 1:}
\begin{verbatim}
$ printf "5\n50 65 35 15 90" | ./disksched --max 199 --start 50 --dir right
ALG FCFS
OK: ORDER 50 65 35 15 90
OK: MOVES 140
ALG SSTF
OK: ORDER 50 35 15 65 90
OK: MOVES 110
ALG SCAN
OK: ORDER 50 65 90 35 15
OK: MOVES 333
ALG C-SCAN
OK: ORDER 50 65 90 15 35
OK: MOVES 383
\end{verbatim}

\textbf{Case 2:}
\begin{verbatim}    
$ printf '1\n200' | ./disksched --max 199 --start 50 --dir left
