% Experiment 17: Paging Address Translation

\section{Experiment 17: Paging Address Translation with Optional TLB}

\subsection{Problem Statement}
The objective is to implement \texttt{pagetrans} to translate virtual addresses to physical ones.

The tool must:
\begin{itemize}
    \item Accept \verb|--pagesize| and optional \verb|--tlb|.
    \item Read page table entries and query addresses from stdin.
    \item Simulate a direct-mapped TLB (if enabled).
    \item Report physical addresses, page faults, and TLB stats.
\end{itemize}

\subsection{Source Code}
\begin{lstlisting}[language=C, caption={pagetrans.c}]
...
\textbf{Case 1:}
\begin{verbatim}
$ printf "2\n0 5 1\n1 9 0\n3\n0\n300\n800" | ./pagetrans --pagesize 256 --tlb 0
...
\textbf{Case 2:}
\begin{verbatim}
$ printf '1\n0 1 1\n2\n10\n10' | ./pagetrans --pagesize 256 --tlb 4
